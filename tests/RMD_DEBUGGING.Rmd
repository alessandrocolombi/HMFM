...
Le stime dei parametri $\mu$ e $\sigma$ sono praticamente uguali al caso in cui la partizione viene tenuta fissa (infatti il clustering è perfetto, non è strano, anzi è quello che c'era da aspettarsi). Quindi la predittiva è buona tanto quanto l'altro caso
```{r}
l_grid = 200
grid = seq(-25,25,length.out = l_grid)
