...
## Confronto
```{r}
pk_MCMC = table(GDFMM$K)/niter
names(pk_MCMC) = paste0(names(pk_MCMC),".25")
plot(pk, type = "h", pch = 16, lty = 1, lwd = 3, xaxt = "n", xlab = "K", col = "red")
points(pk_MCMC, type = "h", col = "black")
mtext(text = as.character(1:20), side = 1, at = 1:20)
```
...
plot(pk_MCMC, type = "h", col = "black", xlab = "K")
```
