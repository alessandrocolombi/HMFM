...
```
Clustering osceno, è sempre su 2 cluster ma non va per niente bene. Inoltre la $U$ esplode su valori giganteschi
...
* $\gamma$ e $U$ hanno delle brutte catene, in particolare $U$ ha valori molto grandi
* $K$ numero di cluster *NON* è quello corretto, è più alto ma si muove tanto, non rimane fisso
...
* $\Lambda$ è molto stabile sui valori scelti dalla prior
* $\gamma$ ora ha valori leggermente più piccoli rispetto a prima
* $U$ ha un solo picco con valori abbastanza contenuti
* $K$ numero di cluster *NON* è quello corretto, è più alto ma si muove tanto, non rimane fisso
* A posteriori però ritrovo il clustering esatto 
* La stima della densità è come vorrei
...
* $\Lambda$ è molto stabile sui valori scelti dalla prior
* $\gamma$ ora ha valori molto molto più piccoli rispetto a prima
* $U$ è oscena, raggiunge valori troppo troppo grandi
* $K$ numero di cluster *NON* è quello corretto e questa volta rimane pure fisso su 1 oppure 2
* A posteriori *NON* ritrovo più il clustering esatto 
* La stima della densità *NON* è più come vorrei
...
Tutto molto bello e molto simile al caso in cui parto dalla partizione vera
...
Magia, funziona bene anche in questo caso.

# CONCLUSIONE
Meglio settare una $P_0$ più stretta rispetto ai dati ma comunque scelta usando il metodo empirical Bayes. Le catene di $U$ sono oscene e arrivano spesso a valori molto molto alti, questo può causare seri problemi se $d>1$.
