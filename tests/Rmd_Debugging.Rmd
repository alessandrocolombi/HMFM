...
option<-list("nu" = 1/10, "Mstar0" = 2, "Lambda0" = 3, "mu0" = 0,"sigma0"= 1, "gamma0" = 1,
             ...
             "UpdateTau" = T, "UpdateLambda" = T, "partition" = init_partition
)
