...
public:
    ...
    FC_gamma(std::string na, double h1, double h2, double pow, unsigned int d, double adapt_var0, double a, double b, double _s_p, bool _keepfixed);
    FC_gamma(std::string na, double h1, double h2, double pow, unsigned int d, double adapt_var0, double a, double b, bool _keepfixed):
